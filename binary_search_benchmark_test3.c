...
#define MAX_DATASET_SIZE 100000  // 100,000 elements
...
int main() {
    ...
    // Define dataset sizes (smaller datasets)
    int dataset_sizes[] = {100, 1000, 10000, 50000};
    ...
    for (int d = 0; d < num_datasets; d++) {
        ...
        for (int dist = 0; dist < num_distributions; dist++) {
            ...
            for (int i = 0; i < iterations; i++) {
                ...
                dummy_improved += res;  // Accumulate results to prevent optimization
            }
            end = clock();
            ...
            for (int i = 0; i < iterations; i++) {
                ...
                dummy_standard += res;  // Accumulate results to prevent optimization
            }
            end = clock();
